package app.graze.demoapiservice.view;
...
import app.graze.demoapiservice.R;
import app.graze.demoapiservice.model.User;
import app.graze.demoapiservice.model.response.BaseResponse;
import app.graze.demoapiservice.network.APIServiceBuilder;
import app.graze.demoapiservice.network.ListAPIService;
import app.graze.demoapiservice.network.NetworkRequest;
import app.graze.demoapiservice.utils.CustomSharedPref;
...
*/
        ...
        listAPIService = APIServiceBuilder.buildAPIService(this, Constants.DOMAIN);
        ...
        subscription = NetworkRequest.
                performAsyncRequest(this,listAPIService.login(user),
                        data->{
                            //luu token
